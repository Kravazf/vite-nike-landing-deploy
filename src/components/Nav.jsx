  ...
  return ( 
    <header className='padding-x py-8 absolute w-full z-50'>
      <nav className='flex justify-between items-center max-container mb-3'>
        ...
        <div className='hidden max-lg:block cursor-pointer fixed right-8 hover:scale-110 hover:duration-300'>
          <img 
            src={hamburger}
            alt="Humburger" 
            width={25}
        ...
        <div
          className={`
            " fixed h-full w-screen lg:hidden bg-black/20 backdrop-blur-sm top-0 left-0  translate-x-full  transition-all duration-500",
            ${isSideMenuOpen && "-translate-x-0 z-50 duration-500"}
            `}
        >
